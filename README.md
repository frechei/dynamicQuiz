这是一个关于javascript的练手项目。在javascript学习期间参考了[[译] 如何恰当地学习 JavaScript](https://github.com/colin4124/colin4124.github.io/blob/master/_source/content/2013-09-28-how-to-learn-javascript-properly.md)一文，要做一个动态提问的项目。    

1. 在两周多时间内学习了他说的前四周内容，紧接着就要求做这个project，开始比较简陋，到后面再慢慢优化。
